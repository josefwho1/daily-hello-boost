...
const PawPrint = ({
  ...
  if (!show) return null;
  return <div className="absolute -top-3 left-1/2 -translate-x-1/2 pointer-events-none">
      <svg viewBox="0 0 24 24" className="w-5 h-5 text-primary animate-paw-print" fill="currentColor">
